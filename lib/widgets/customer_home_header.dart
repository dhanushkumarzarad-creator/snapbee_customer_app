...
/// row (city + short address, tappable) plus up to two trailing action
/// icons. Fully theme-parameterized (background/text/icon colors) so every
/// sector renders this same structure/spacing/behavior in its own brand
/// color rather than each sector maintaining its own near-identical copy.
///
      ...
      child: Row(
        ...
        children: [
          ...
          for (final action in actions) ...[
            ...
            _HeaderIconButton(icon: action.icon, badgeCount: action.badgeCount, onTap: action.onTap, iconColor: iconColor),
          ],
        ],
      ),
    );
